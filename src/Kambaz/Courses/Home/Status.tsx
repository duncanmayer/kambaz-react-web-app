import { MdDoNotDisturbAlt, MdHome, MdBarChart, MdAnnouncement, MdOutlineDoorbell } from "react-icons/md";
 ...
 return (
   <div id="wd-course-status" style={{ width: "325px" }}>
     ...
     <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       ...
       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <MdOutlineDoorbell className="me-2 fs-5" /> View Course Notifications </Button>
