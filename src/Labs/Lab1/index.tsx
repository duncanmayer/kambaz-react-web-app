...
This is a paragraph. We often separate a long set of sentences with vertical spaces to make the text easier to read. Browsers ignore vertical white spaces and render all the text as one single set of sentences. To force the browser to add vertical spacing, wrap the paragraphs you want to separate with the paragraph tag
        ...
        <ol id="wd-your-favorite-recipe">
            <li>Heat a skillet and add butter to the pan.</li>
            <li>Apply butter or mayo to the outer edges of the bread.</li>
            <li>Place a slice of cheese in between the two slices of bread.</li>
            <li>Place the sandwich on the skillet.</li>
            <li>Cook Grilled Cheese until golden brown on one side, then flip.</li>
            <li>Once other side is golden brown and cheese is melted, serve and enjoy.</li>
        </ol>
